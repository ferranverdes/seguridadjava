        ...
        <div class="wrapper">
            ...
            <div id="content">
                <%
                    ...
                    /*Protección insegura. Se eliminan las etiquetas <script> case insensitive.
                    - Usar payload <s<script>cript>alert(1)</script>
                    - Usar payload <img src="error.gif" onerror="javascript:alert(1)"/>
                    */
                    search = search.replaceAll("(?i)<script>", "");
                %>
                <h1>XSS scriptlet</h1>
                <p>Búsqueda <% out.print(search); %> :</p>
                <form method="GET">
